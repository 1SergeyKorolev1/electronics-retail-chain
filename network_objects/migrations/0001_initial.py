...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Завод', 'Завод'), ('Cеть', 'Розничная сеть'), ('Предприниматель', 'Индивидуальный предприниматель')], help_text='Выберите тип поставщика', verbose_name='тип поставщика')),
                ('supplier_level', models.IntegerField(blank=True, default=0, null=True, verbose_name='уровень в цепочке поставок')),
                ...
                ('contacts', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='network_objects.contacts', verbose_name='Контакты')),
                ('products', models.ManyToManyField(blank=True, null=True, to='network_objects.product', verbose_name='Продукт')),
