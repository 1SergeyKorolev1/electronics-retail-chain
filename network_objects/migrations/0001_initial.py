# Generated by Django 5.0.7 on 2024-09-13 22:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Завод', 'Завод'), ('Розничная сеть', 'Сеть'), ('индивидуальный предприниматель', 'Предприниматель')], help_text='Выберите тип поставщика', verbose_name='тип поставщика')),
